...
(function () {
   ...
   if (!organizationId) {
      console.error(
         "Samadhan Widget: data-organization-id attribute is required"
      );
      return;
   }
   ...
   function render() {
      ...
      button.id = "samadhan-widget-button";
    ...
    `;
      ...
      container.id = "samadhan-widget-container";
